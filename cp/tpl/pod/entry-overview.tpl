      ...
      <div class="incp-card-body">
        <div class="incp-card-frame-inline">
          <div class="incp-card-frame incp-card-frame-p33 incp-card-body-inline-item">
            <div class="table-row">
              <div class="name">
                Pod ID 
                <span class="incp-btn-hover" onclick="inCp.CopyToClipboard('incp-podentry-pod-id')" title="Copy to Clipboard">
                  <span class="fas fa-clone"></span>
                </span>
              </div>
            </div>
            <div class="table-row">
              <div class="value" id="incp-podentry-pod-id">{[=it.meta.id]}</div>
            </div>
          </div>
          <div class="incp-card-frame incp-card-frame-p33 incp-card-body-inline-item">
            <div class="table-row">
        ...
        <div class="incp-card-frame-inline">
          ...
          <div class="incp-card-frame incp-card-frame-p33 incp-card-body-inline-item">
            ...
            <div class="table-row">
              <div class="value" id="incp-podentry-payment-amount">{[? it.payment &&
                it.payment._cycle_amount]}{[=it.payment._cycle_amount]}{[?]}</div>
            </div>
          </div>
          <div class="incp-card-frame incp-card-frame-p33 incp-card-body-inline-item">
            <div class="table-row">
            ...
            <div class="table-row">
              <div class="value incp-font-ok" id="incp-podentry-status-value">- / {[=it.operate.replica_cap]}</div>
            </div>
          </div>
        </div>
      ...
      <div class="incp-card-body">
        <div class="incp-card-frame-inline">
          ...
          <div class="incp-card-frame incp-card-frame-c6 incp-card-body-inline-item">
            ...
            <div class="table-row">
              <div class="value"
                title="{[? it.spec.box.image.ref_title]}{[=it.spec.box.image.ref_title]} - {[?]}{[=it.spec._box_image_driver]}">
                {[? it.spec.box.image.ref_title]}{[=it.spec.box.image.ref_title]} - {[?]}{[=it.spec._box_image_driver]}
              </div>
            </div>
          </div>
        </div>
        ...
        <table class="valign-middle incp-formtable-space-x0050">
          ...
          <tbody>
            ...
            <tr class="incp-formtable-tr-line">
              ...
              <td>
                <a href="#"
                  onclick="inCpAppSpec.Info('{[=v.spec.meta.id]}', null, '{[=v.spec.meta.version]}', '{[=v.meta.id]}');return false">
              ...
              <td>
                ...
                <button class="btn btn-sm btn-default" onclick="inCpApp.OpOptInfo('{[=v.meta.id]}')"
          ...
          <tbody>
            ...
            <tr class="incp-formtable-tr-line">
                ...
                <table class="incp-font-fixspace table-reset" style="width:100%">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="{[=opv.name]}://{[=opv.wan_addr]}:{[=opv.host_port]}"
                        target="_blank">{[=opv.name]}://{[=opv.wan_addr]}:{[=opv.host_port]}</a>
              ...
              <td id="incp-podentry-repitem-setup-{[=rep.rep_id]}" align="right">
                ...
                {[?]}
                {[if (inCp.syscfg.zone_master.multi_replica_enable && !inCp.OpActionAllow(it.operate.action,
                inCp.OpActionDestroy)) {]}
